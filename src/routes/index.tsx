...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-brand-primary">
      ...
      <section id="top" className="px-6 py-16 md:py-24">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-14 md:flex-row">
          <div className="flex-1 space-y-7 animate-fade-up">
            <div className="inline-flex items-center rounded-full bg-brand-accent/10 px-3 py-1 text-xs font-bold uppercase tracking-widest text-brand-accent">Riyadh, Saudi Arabia · Open to opportunities</div>
